...
The version control piece comes in through software called Git. Git is designed for coordinatin work among programmers and keeping track of the different versions over time. Git prioritizes speed and data integrity. People usually use Git by coding at the command line. Instead of doing that, we will use GutHub Desktop which allows you to do version control in a graphical user interface (instead of coding). If you want to learn how to code at the command line, ask Sierra for some tutorials or start here: https://blog.udacity.com/2015/06/a-beginners-git-github-tutorial.html. Be very careful when coding at the command line. It is easy to delete entire directories on your computer without meaning to. 
...
3. Practice knitting this R Markdown file and render the html for future reference (see the first tutorial for help)

4. Practice navigating the GitHub Desktop by adding Sierra's repo called "USAid_mapping" and opening the R Markdown file called "activity.Rmd". You can get started on the basic R tutorial for mapping found online. We will continue working on this tutorial in class on September 7th. An accompanying video will be available on Canvas for the second part of this environmental justice and mapping tutorial.
