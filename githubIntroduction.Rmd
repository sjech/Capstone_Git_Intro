...
In your web browser, navigate to Sierra’s online GitHub repository “USAid_mapping” and find the large green “Code” button. Click on this button and find the clipboard next to the URL. Click on this to copy the URL. Now paste the URL into the GitHub Desktop prompt. 
...
Note: If you have trouble locating the URL for the repo, here is the URL: https://github.com/sjech/USAid_mapping