...
4. Practice navigating the GitHub Desktop by adding Sierra's repo called "USAid_mapping" (instructions below if you need help). We will work through the mapping tutorial in class on September 7th. An accompanying video will be available on Canvas if you'd like to see how Sierra navigates RStudio for coding.
